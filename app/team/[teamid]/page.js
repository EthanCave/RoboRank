        ...
        if (action === 'accept') {
          ...
          if (requestData) {
            ...
            await updateDoc(teamRef, {
              members: arrayUnion({ uid: requestData.uid, role: 'member' })
            });
    ...
    return (
      <div className={styles.teamContainer}>
        ...
        <div className={styles.contentWrapper}>
          ...
          {activeTab === 'requests' && isMember && (
            <JoinRequests requests={requests} onAction={handleRequestAction} />
          )}
        </div>
      </div>
    );
